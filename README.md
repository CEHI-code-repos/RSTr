...
If this is your first time using RSTr, visit the [RSTr pkgdown website](https://cehicapacitybuilding.org/RSTr/) or check out `vignette("RSTr")` to learn how to use the package.
