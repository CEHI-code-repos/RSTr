...
The UCAR model used by RSTr is based on the model developed by [Besag, York, and Mollié (1991)](https://doi.org/10.1007/BF00116466) with modifications using inverse transform sampling for restricted informativeness based on [Quick, et al. (2021)](https://doi.org/10.1016/j.sste.2021.100420):
