...
-   `sig2` represents the spatial variance of a CAR/RCAR model. This parameter picks up any variance in values of `Z` for each group. It is a `matrix` of size `n_group x n_time` of positive real numbers.
